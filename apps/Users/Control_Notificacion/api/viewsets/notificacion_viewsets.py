...
from apps.Users.Control_Notificacion.api.serializers.notificacion_serializers import NotiListSerializers, NotiSerializers


class NotiListViewSet(viewsets.ModelViewSet):
    serializer_class = NotiListSerializers
