...
from apps.Ganado.Control_Ganado import serializer
...
from apps.Ganado.Control_Peso.serializer import Create_enfermedad, Peso_Serializer , Vacas_Serializer , Enfermedades_Serializer
