...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Control_G', '0004_rename_raza_ganado_id_raza'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_toro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='control_empadre_requests_created', to='Control_G.ganado')),
                ('vaca_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Control_G.ganado')),
            ],
            options={
